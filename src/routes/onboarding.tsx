    ...
    try {
      ...
      toast.error(
        err instanceof Error
          ? err.message
          : t("onboarding.toast.error", { defaultValue: "Something went wrong" }),
      );
    } finally {
      setLoading(false);
    }
      ...
      <Card className="w-full max-w-lg">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-2xl">
            {step === 1 &&
              t("onboarding.step1.welcome", { defaultValue: "Welcome! Let's get started" })}
            {step === 2 && t("onboarding.step2.tellUs", { defaultValue: "Tell us about yourself" })}
            {step === 3 &&
              t("onboarding.step3.emergencyContact", { defaultValue: "Emergency contact" })}
            {step === 4 && t("onboarding.step4.reviewInfo", { defaultValue: "Review your info" })}
          </CardTitle>
          <CardDescription>
            {step === 1 &&
              t("onboarding.step1.setupProfile", { defaultValue: "Set up your health profile" })}
            {step === 2 &&
              t("onboarding.step2.personalize", {
                defaultValue: "This helps us personalize your experience",
              })}
            {step === 3 &&
              t("onboarding.step3.emergencyContactOptional", {
                defaultValue: "Someone we can contact in case of emergency",
              })}
            {step === 4 &&
              t("onboarding.step4.makeSureCorrect", {
                defaultValue: "Make sure everything looks correct",
              })}
          </CardDescription>
        </CardHeader>
        <CardContent>
            ...
            <div className="space-y-4">
              <div>
                <Label htmlFor="displayName">
                  {t("onboarding.step1.nameLabel", { defaultValue: "Your name *" })}
                </Label>
                <Input
                  id="displayName"
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <Label htmlFor="gender">
                    {t("onboarding.step1.genderLabel", { defaultValue: "Gender" })}
                  </Label>
                  <Select
                    value={data.gender}
                  ...
                  >
                    <SelectTrigger id="gender" className="mt-1.5">
                      <SelectValue
                        placeholder={t("onboarding.step1.genderPlaceholder", {
                          defaultValue: "Select...",
                        })}
                      />
                    </SelectTrigger>
              ...
              <div>
                <Label htmlFor="bodyWeight">
                  {t("onboarding.step1.weightLabel", { defaultValue: "Body weight (kg)" })}
                </Label>
                <Input
                  id="bodyWeight"
                  type="number"
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="text-sm font-medium">
                  {t("onboarding.step2.locationOptional", { defaultValue: "Location (optional)" })}
                </span>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <Label htmlFor="country">
                    {t("onboarding.step2.countryLabel", { defaultValue: "Country" })}
                  </Label>
                  <Input
                    id="country"
                ...
                <div>
                  <Label htmlFor="city">
                    {t("onboarding.step2.cityLabel", { defaultValue: "City" })}
                  </Label>
                  <Input
                    id="city"
              ...
              <div className="border-t pt-4 mt-4">
                <Label htmlFor="allergies">
                  {t("onboarding.step2.allergiesLabel", {
                    defaultValue: "Allergies (comma separated)",
                  })}
                </Label>
                <Input
                  id="allergies"
                  placeholder={t("onboarding.step2.allergiesPlaceholder", {
                    defaultValue: "Peanuts, Penicillin, Pollen",
                  })}
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  {t("onboarding.step2.allergiesDescription", {
                    defaultValue:
                      "List any allergies to medications, foods, or environmental factors",
                  })}
                </p>
              </div>
              ...
              <div>
                <Label htmlFor="chronicConditions">
                  {t("onboarding.step2.chronicConditionsLabel", {
                    defaultValue: "Chronic conditions (comma separated)",
                  })}
                </Label>
                <Input
                  id="chronicConditions"
                  placeholder={t("onboarding.step2.chronicConditionsPlaceholder", {
                    defaultValue: "Diabetes, Hypertension, Asthma",
                  })}
              ...
              <div>
                <Label htmlFor="pastIllnesses">
                  {t("onboarding.step2.pastIllnessesLabel", {
                    defaultValue: "Past illnesses (comma separated)",
                  })}
                </Label>
                <Input
                  id="pastIllnesses"
                  placeholder={t("onboarding.step2.pastIllnessesPlaceholder", {
                    defaultValue: "COVID-19, Appendectomy, Chickenpox",
                  })}
              ...
              <div>
                <Label htmlFor="hereditaryDiseases">
                  {t("onboarding.step2.hereditaryDiseasesLabel", {
                    defaultValue: "Hereditary diseases in family (comma separated)",
                  })}
                </Label>
                <Input
                  id="hereditaryDiseases"
                  placeholder={t("onboarding.step2.hereditaryDiseasesPlaceholder", {
                    defaultValue: "Heart disease, Cancer, Diabetes",
                  })}
          ...
          {step === 3 && (
            <div className="space-y-4">
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="text-sm font-medium">
                  {t("onboarding.step3.emergencyContactOptionalLabel", {
                    defaultValue: "Emergency contact (optional)",
                  })}
                </span>
              </div>
              ...
              <div>
                <Label htmlFor="emergencyName">
                  {t("onboarding.step3.contactNameLabel", { defaultValue: "Contact name" })}
                </Label>
                <Input
                  id="emergencyName"
                  placeholder={t("onboarding.step3.contactNamePlaceholder", {
              ...
              <div>
                <Label htmlFor="emergencyPhone">
                  {t("onboarding.step3.contactPhoneLabel", { defaultValue: "Phone number" })}
                </Label>
                <Input
                  id="emergencyPhone"
                  type="tel"
                  placeholder={t("onboarding.step3.contactPhonePlaceholder", {
              ...
              <div className="bg-muted/50 rounded-lg p-4 space-y-2 text-sm">
                <div className="flex justify-between">
                  <span className="text-muted-foreground">
                    {t("onboarding.step4.name", { defaultValue: "Name:" })}
                  </span>
                  <span className="font-medium">{data.displayName || "-"}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-muted-foreground">
                    {t("onboarding.step4.age", { defaultValue: "Age:" })}
                  </span>
                  <span className="font-medium">{data.age || "-"}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-muted-foreground">
                    {t("onboarding.step4.gender", { defaultValue: "Gender:" })}
                  </span>
                  <span className="font-medium">{data.gender || "-"}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-muted-foreground">
                    {t("onboarding.step4.weight", { defaultValue: "Weight:" })}
                  </span>
                ...
                <div className="flex justify-between">
                  <span className="text-muted-foreground">
                    {t("onboarding.step4.location", { defaultValue: "Location:" })}
                  </span>
                  <span className="font-medium">
                ...
                <div className="flex justify-between">
                  <span className="text-muted-foreground">
                    {t("onboarding.step4.allergies", { defaultValue: "Allergies:" })}
                  </span>
                  <span className="font-medium">{data.allergies || "-"}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-muted-foreground">
                    {t("onboarding.step4.chronicConditions", {
                ...
                <div className="flex justify-between">
                  <span className="text-muted-foreground">
                    {t("onboarding.step4.emergencyContact", { defaultValue: "Emergency contact:" })}
                  </span>
                  <span className="font-medium">
          ...
          <div className="flex gap-3 mt-6">
            ...
            {step < 4 ? (
              <Button
                ...
                disabled={!canProceed()}
              >
                {t("onboarding.buttons.continue", { defaultValue: "Continue" })}{" "}
